...
public class HomeController extends Controller {
     ...
     */
    int count = 0;
    public synchronized  Result fileUploadApi(Http.Request request) throws  Exception{
...
//        }
        ThreadFileUpload TFU = new ThreadFileUpload(body, uploadedFile, datasetService, ++count);
        FutureTask<Result> result = new FutureTask<>(TFU);
